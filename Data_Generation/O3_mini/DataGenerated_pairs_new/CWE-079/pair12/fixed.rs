...
impl TemplateEngine {
    ...
    // A helper function to escape reserved HTML characters.
    ...
    // Render safely by escaping the user input before inserting it into the template.
    // This removes the unsafe memory manipulation and prevents XSS.
...
fn main() {
    ...
    let handle = thread::spawn(move || {
        ...
        // Safe untrusted input - now properly escaped.
