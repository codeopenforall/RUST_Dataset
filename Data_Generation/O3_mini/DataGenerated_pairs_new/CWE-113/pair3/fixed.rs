///////////////////////////////////////////////////////////////
// Secure Fix: HTTP Response Header Sanitization
// This version prevents HTTP response splitting by sanitizing any CR
// or LF characters from the untrusted input. It uses safe Rust string
// manipulation and avoids unsafe constructs.
///////////////////////////////////////////////////////////////
...
impl ResponseBuilder {
    ...
    // Safely adds a header by removing any CR or LF characters from the value.
...
// This function is used by main and can be invoked externally for testing.
