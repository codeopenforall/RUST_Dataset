...
impl HeaderBuilder {
    ...
    // This unsafe function now sanitizes the input by removing CR and LF characters to prevent header injection.
...
fn main() {
    // Simulated untrusted input; CRLF characters will be removed by sanitization.
