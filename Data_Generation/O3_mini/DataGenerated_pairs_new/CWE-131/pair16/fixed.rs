///////////////////////////////////////////////////////////////
// Fixed Code Sample for Correct Buffer Size Calculation
///////////////////////////////////////////////////////////////
...
impl Data {
    ...
    // FIX: Correctly using input.len() to compute the length.
...
fn main() {
    // The input is fully copied since the correct length is computed using input.len().
