...
fn process(req: &Request) -> Result<&'static str, &'static str> {
    // Enforce strict header checks to prevent any inconsistent interpretations.
...
fn main() {
    // Minimal TCP server with secure request parsing.
