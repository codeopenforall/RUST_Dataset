/////////////////////////////////////////////////////////////
// Corrected Example: Strict and Safe HTTP Request Parsing  //
/////////////////////////////////////////////////////////////
...
pub fn parse_input(input: &str) -> Result<HTTPRequest, &'static str> {
    // Split input into header and body sections.
    ...
    // Process headers safely, and check for duplicates.
    ...
    for line in header_lines {
        ...
        // If a header appears more than once, reject the request to avoid ambiguity.
    ...
    // Verify the Content-Length header if present.
...
fn main() {
    // The same input with duplicate Content-Length headers is now rejected.
