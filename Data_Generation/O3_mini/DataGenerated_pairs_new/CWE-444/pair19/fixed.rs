...
impl HttpRequest {
    pub fn parse(raw: &str) -> Result<Self, String> {
        ...
        let body: String;
        // When both headers are present, the parser now prioritizes Transfer-Encoding,
        // ignoring Content-Length to avoid misinterpretation.
        if transfer_encoding {
            // Simulated safe chunked decoding without any unsafe pointer operations.
...
fn main() {
    // The same HTTP request input is processed, but now the headers are interpreted consistently.
