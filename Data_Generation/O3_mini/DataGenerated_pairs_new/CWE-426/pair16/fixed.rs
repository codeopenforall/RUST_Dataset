...
impl Loader {
    fn new() -> Self {
        // Mitigation: use an absolute path to ensure the correct executable is loaded.
        Loader {
    ...
    fn run(&self) -> Result<String, String> {
        // Validate that the command has an absolute path before executing.
        if !self.is_secure() {
    ...
    fn is_secure(&self) -> bool {
        // Use Path API to reliably check if the path is absolute.
