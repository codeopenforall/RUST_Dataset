...
const MAX_ALLOC: usize = 100_000; // Maximum allowed allocation size
...
impl Allocator {
    ...
    // This function now enforces a maximum allocation limit.
    // If the requested number of bytes exceeds MAX_ALLOC, an error is returned.
...
fn main() {
    ...
    // Here the allocation request is within safe limits.
