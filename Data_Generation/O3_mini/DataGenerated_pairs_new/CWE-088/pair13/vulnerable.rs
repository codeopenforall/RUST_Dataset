...
impl Executor {
    ...
    fn run(&self) -> Result<String, String> {
        // Build a shell command by directly concatenating an untrusted string.
        // CWE-088: OS Command Injection — untrusted input is injected into the command.
        let cmd_str = format!("ls {}", self.command);
        // Using an unsafe block to simulate use of unsafe constructs in real-world code.
        unsafe {
...
fn main() {
    // Accepting untrusted input from the command line.
