///////////////////////////////////////////////////////////////
// Vulnerable Implementation for CWE-252: Unchecked Return Value
///////////////////////////////////////////////////////////////
...
fn execute(input: u32) -> Result<u32, &'static str> {
    ...
    let h = thread::spawn(move || {
        // Use of an unsafe block along with ignoring the returned error.
        unsafe {
            // WARNING: The return value of 'critical' is deliberately discarded.
    ...
    h.join().unwrap();
    // Always returns a success value even if 'critical' failed.
