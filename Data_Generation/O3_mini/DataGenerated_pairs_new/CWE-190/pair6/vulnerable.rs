...
impl Calculator {
    ...
    // Performs arithmetic without checking conversions or overflow.
    fn compute(&self, base: i32, input: u32) -> i32 {
        unsafe {
            // Vulnerability: the unchecked conversion from u32 to i32 causes truncation.
            // For a large unsigned value (e.g. 0xFFFF_FFFF), (input as i32) becomes -1.
...
fn main() {
    ...
    // Use a large number that cannot be represented in i32.
