...
impl ResourceManager {
    ...
    // Improved allocation function that enforces a maximum number of tasks.
    // Returns an error if the requested count exceeds SAFE_LIMIT.
...
fn main() {
    ...
    // Demonstration allocation: only a safe number of tasks is allowed.
