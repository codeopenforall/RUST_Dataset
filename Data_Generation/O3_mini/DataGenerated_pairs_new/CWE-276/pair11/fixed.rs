...
impl ConfigManager {
    fn new() -> Result<Self, Box<dyn Error>> {
        // Creating file with restricted permissions 0o600 (read-write for owner only)
        let file = OpenOptions::new()
            .write(true)
            .create(true)
            .mode(0o600)  // Secure default permissions
    ...
    fn write_config(&self, data: &[u8]) -> Result<(), Box<dyn Error>> {
        ...
        unsafe {
            // Retained unsafe block for legacy compatibility; ensure raw pointer use is benign
